...
func resourceSystemAutoupdatePushUpdateDelete(d *schema.ResourceData, m interface{}) error {
	...
	_, err = c.UpdateSystemAutoupdatePushUpdate(obj, mkey)
	if err != nil {
...
func flattenSystemAutoupdatePushUpdateFortiTestDebug(d *schema.ResourceData, fswdebugsn int, fswdebugbeg int, fswdebugend int) {
