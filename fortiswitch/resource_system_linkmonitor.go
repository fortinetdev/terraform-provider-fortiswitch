...
func flattenSystemLinkMonitorTimeout(v interface{}, d *schema.ResourceData, pre string, sv string) interface{} {
	return v
}
...
func refreshObjectSystemLinkMonitor(d *schema.ResourceData, o map[string]interface{}, sv string) error {
	...
	if err = d.Set("timeout", flattenSystemLinkMonitorTimeout(o["timeout"], d, "timeout", sv)); err != nil {
...
func flattenSystemLinkMonitorFortiTestDebug(d *schema.ResourceData, fswdebugsn int, fswdebugbeg int, fswdebugend int) {
...
func expandSystemLinkMonitorTimeout(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	return v, nil
}
...
func getObjectSystemLinkMonitor(d *schema.ResourceData, sv string) (*map[string]interface{}, error) {
	...
	if v, ok := d.GetOk("timeout"); ok {
		...
		t, err := expandSystemLinkMonitorTimeout(d, v, "timeout", sv)
		if err != nil {
			return &obj, err
		} else if t != nil {
			obj["timeout"] = t
