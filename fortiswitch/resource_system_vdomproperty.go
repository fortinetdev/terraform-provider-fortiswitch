...
// Description: Vdom-property configuration.
...
func flattenSystemVdomPropertyFortiTestDebug(d *schema.ResourceData, fswdebugsn int, fswdebugbeg int, fswdebugend int) {
