...
func dataSourceFlattenRouterRouteMapProtocol(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return v
}
...
func dataSourceRefreshObjectRouterRouteMap(d *schema.ResourceData, o map[string]interface{}) error {
	...
	if err = d.Set("protocol", dataSourceFlattenRouterRouteMapProtocol(o["protocol"], d, "protocol")); err != nil {
...
func dataSourceFlattenRouterRouteMapFortiTestDebug(d *schema.ResourceData, fswdebugsn int, fswdebugbeg int, fswdebugend int) {
