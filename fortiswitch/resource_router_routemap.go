...
func flattenRouterRouteMapProtocol(v interface{}, d *schema.ResourceData, pre string, sv string) interface{} {
	return v
}
...
func refreshObjectRouterRouteMap(d *schema.ResourceData, o map[string]interface{}, sv string) error {
	...
	if err = d.Set("protocol", flattenRouterRouteMapProtocol(o["protocol"], d, "protocol", sv)); err != nil {
...
func flattenRouterRouteMapFortiTestDebug(d *schema.ResourceData, fswdebugsn int, fswdebugbeg int, fswdebugend int) {
...
func expandRouterRouteMapProtocol(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	return v, nil
}
...
func getObjectRouterRouteMap(d *schema.ResourceData, sv string) (*map[string]interface{}, error) {
	...
	if v, ok := d.GetOk("protocol"); ok {
		...
		t, err := expandRouterRouteMapProtocol(d, v, "protocol", sv)
		if err != nil {
			return &obj, err
		} else if t != nil {
			obj["protocol"] = t
