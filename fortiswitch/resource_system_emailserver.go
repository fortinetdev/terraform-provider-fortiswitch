...
func resourceSystemEmailServerDelete(d *schema.ResourceData, m interface{}) error {
	...
	_, err = c.UpdateSystemEmailServer(obj, mkey)
	if err != nil {
...
func refreshObjectSystemEmailServer(d *schema.ResourceData, o map[string]interface{}, sv string) error {
	...
	if err = d.Set("password", flattenSystemEmailServerPassword(o["password"], d, "password", sv)); err != nil {
...
func flattenSystemEmailServerFortiTestDebug(d *schema.ResourceData, fswdebugsn int, fswdebugbeg int, fswdebugend int) {
