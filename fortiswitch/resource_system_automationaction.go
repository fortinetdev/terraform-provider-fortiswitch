...
func flattenSystemAutomationActionSnmpTrap(v interface{}, d *schema.ResourceData, pre string, sv string) interface{} {
	return v
}
...
func refreshObjectSystemAutomationAction(d *schema.ResourceData, o map[string]interface{}, sv string) error {
	...
	if err = d.Set("snmp_trap", flattenSystemAutomationActionSnmpTrap(o["snmp-trap"], d, "snmp_trap", sv)); err != nil {
...
func flattenSystemAutomationActionFortiTestDebug(d *schema.ResourceData, fswdebugsn int, fswdebugbeg int, fswdebugend int) {
...
func expandSystemAutomationActionSnmpTrap(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	return v, nil
}
...
func getObjectSystemAutomationAction(d *schema.ResourceData, sv string) (*map[string]interface{}, error) {
	...
	if v, ok := d.GetOk("snmp_trap"); ok {

		t, err := expandSystemAutomationActionSnmpTrap(d, v, "snmp_trap", sv)
		if err != nil {
			return &obj, err
		} else if t != nil {
			obj["snmp-trap"] = t
