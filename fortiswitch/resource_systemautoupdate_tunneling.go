...
func resourceSystemAutoupdateTunnelingDelete(d *schema.ResourceData, m interface{}) error {
	...
	_, err = c.UpdateSystemAutoupdateTunneling(obj, mkey)
	if err != nil {
...
func refreshObjectSystemAutoupdateTunneling(d *schema.ResourceData, o map[string]interface{}, sv string) error {
	...
	if err = d.Set("password", flattenSystemAutoupdateTunnelingPassword(o["password"], d, "password", sv)); err != nil {
...
func flattenSystemAutoupdateTunnelingFortiTestDebug(d *schema.ResourceData, fswdebugsn int, fswdebugbeg int, fswdebugend int) {
