...
func dataSourceFlattenSystemAutomationActionSnmpTrap(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return v
}
...
func dataSourceRefreshObjectSystemAutomationAction(d *schema.ResourceData, o map[string]interface{}) error {
	...
	if err = d.Set("aws_api_key", dataSourceFlattenSystemAutomationActionAwsApiKey(o["aws-api-key"], d, "aws_api_key")); err != nil {
	...
	if err = d.Set("azure_api_key", dataSourceFlattenSystemAutomationActionAzureApiKey(o["azure-api-key"], d, "azure_api_key")); err != nil {
	...
	if err = d.Set("alicloud_access_key_secret", dataSourceFlattenSystemAutomationActionAlicloudAccessKeySecret(o["alicloud-access-key-secret"], d, "alicloud_access_key_secret")); err != nil {
	...
	if err = d.Set("snmp_trap", dataSourceFlattenSystemAutomationActionSnmpTrap(o["snmp-trap"], d, "snmp_trap")); err != nil {
		if !fortiAPIPatch(o["snmp-trap"]) {
			return fmt.Errorf("Error reading snmp_trap: %v", err)
		}
	}
...
func dataSourceFlattenSystemAutomationActionFortiTestDebug(d *schema.ResourceData, fswdebugsn int, fswdebugbeg int, fswdebugend int) {
