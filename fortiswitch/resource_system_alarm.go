...
func resourceSystemAlarmDelete(d *schema.ResourceData, m interface{}) error {
	...
	_, err = c.UpdateSystemAlarm(obj, mkey)
	if err != nil {
...
func flattenSystemAlarmGroupsFwPolicyViolations(v interface{}, d *schema.ResourceData, pre string, sv string) []map[string]interface{} {
	...
	dynamic_sort_subtable(result, "threshold", d)
	return result
}
...
func flattenSystemAlarmSequence(v interface{}, d *schema.ResourceData, pre string, sv string) interface{} {
	return v
}
...
func refreshObjectSystemAlarm(d *schema.ResourceData, o map[string]interface{}, sv string) error {
	...
	if err = d.Set("sequence", flattenSystemAlarmSequence(o["sequence"], d, "sequence", sv)); err != nil {
		if !fortiAPIPatch(o["sequence"]) {
			return fmt.Errorf("Error reading sequence: %v", err)
		}
	}
...
func flattenSystemAlarmFortiTestDebug(d *schema.ResourceData, fswdebugsn int, fswdebugbeg int, fswdebugend int) {
...
func expandSystemAlarmSequence(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	return v, nil
}
...
func getObjectSystemAlarm(d *schema.ResourceData, setArgNil bool, sv string) (*map[string]interface{}, error) {
	...
	if v, ok := d.GetOk("sequence"); ok {
		if setArgNil {
			...
			t, err := expandSystemAlarmSequence(d, v, "sequence", sv)
			if err != nil {
				return &obj, err
			} else if t != nil {
				obj["sequence"] = t
