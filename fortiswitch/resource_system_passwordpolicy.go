...
// Description: Config password policy.
...
func resourceSystemPasswordPolicyDelete(d *schema.ResourceData, m interface{}) error {
	...
	_, err = c.UpdateSystemPasswordPolicy(obj, mkey)
	if err != nil {
...
func flattenSystemPasswordPolicyFortiTestDebug(d *schema.ResourceData, fswdebugsn int, fswdebugbeg int, fswdebugend int) {
