...
func resourceSystemManagementTunnelDelete(d *schema.ResourceData, m interface{}) error {
	...
	_, err = c.UpdateSystemManagementTunnel(obj, mkey)
	if err != nil {
...
func flattenSystemManagementTunnelFortiTestDebug(d *schema.ResourceData, fswdebugsn int, fswdebugbeg int, fswdebugend int) {
