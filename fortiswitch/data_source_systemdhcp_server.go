...
func dataSourceRefreshObjectSystemDhcpServer(d *schema.ResourceData, o map[string]interface{}) error {
	...
	if err = d.Set("fswid", dataSourceFlattenSystemDhcpServerId(o["id"], d, "fswid")); err != nil {
...
func dataSourceFlattenSystemDhcpServerFortiTestDebug(d *schema.ResourceData, fswdebugsn int, fswdebugbeg int, fswdebugend int) {
