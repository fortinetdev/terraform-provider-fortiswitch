...
func resourceLogSyslogdSettingDelete(d *schema.ResourceData, m interface{}) error {
	...
	_, err = c.UpdateLogSyslogdSetting(obj, mkey)
	if err != nil {
...
func flattenLogSyslogdSettingOverride(v interface{}, d *schema.ResourceData, pre string, sv string) interface{} {
	return v
}

func flattenLogSyslogdSettingCsv(v interface{}, d *schema.ResourceData, pre string, sv string) interface{} {
	return v
}
...
func refreshObjectLogSyslogdSetting(d *schema.ResourceData, o map[string]interface{}, sv string) error {
	...
	if err = d.Set("override", flattenLogSyslogdSettingOverride(o["override"], d, "override", sv)); err != nil {
		if !fortiAPIPatch(o["override"]) {
			return fmt.Errorf("Error reading override: %v", err)
		}
	}

	if err = d.Set("csv", flattenLogSyslogdSettingCsv(o["csv"], d, "csv", sv)); err != nil {
...
func flattenLogSyslogdSettingFortiTestDebug(d *schema.ResourceData, fswdebugsn int, fswdebugbeg int, fswdebugend int) {
...
func expandLogSyslogdSettingOverride(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	return v, nil
}

func expandLogSyslogdSettingCsv(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	return v, nil
}
...
func getObjectLogSyslogdSetting(d *schema.ResourceData, setArgNil bool, sv string) (*map[string]interface{}, error) {
	...
	if v, ok := d.GetOk("override"); ok {
		if setArgNil {
			...
			t, err := expandLogSyslogdSettingOverride(d, v, "override", sv)
			if err != nil {
				return &obj, err
			} else if t != nil {
				obj["override"] = t
	...
	if v, ok := d.GetOk("csv"); ok {
		if setArgNil {
			...
			t, err := expandLogSyslogdSettingCsv(d, v, "csv", sv)
			if err != nil {
				return &obj, err
			} else if t != nil {
				obj["csv"] = t
