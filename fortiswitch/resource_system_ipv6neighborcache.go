...
func refreshObjectSystemIpv6NeighborCache(d *schema.ResourceData, o map[string]interface{}, sv string) error {
	...
	if err = d.Set("fswid", flattenSystemIpv6NeighborCacheId(o["id"], d, "fswid", sv)); err != nil {
...
func flattenSystemIpv6NeighborCacheFortiTestDebug(d *schema.ResourceData, fswdebugsn int, fswdebugbeg int, fswdebugend int) {
...
func getObjectSystemIpv6NeighborCache(d *schema.ResourceData, sv string) (*map[string]interface{}, error) {
	...
	if v, ok := d.GetOk("fswid"); ok {
		...
		t, err := expandSystemIpv6NeighborCacheId(d, v, "fswid", sv)
		if err != nil {
			return &obj, err
		} else if t != nil {
			obj["id"] = t
